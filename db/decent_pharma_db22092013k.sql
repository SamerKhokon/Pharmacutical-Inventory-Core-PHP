...
insert  into `hr_emp_dept_info`(`dep_id`,`dept_name`,`dept_code`,`dept_address`,`dept_contact_no`,`dept_email`,`entry_by`,`entry_date`,`last_update_by`,`last_update_date`,`company_id`,`active_flag`) values (1,'Human Resource','HR','Dhaka','0125633322','hr@info.co',1,'2013-09-19 00:00:00',0,'2013-09-19 07:07:16',1,'Y'),(2,'Inventory','inv','Dhaka','0178423754','inv@info.com',1,'2013-09-21 00:00:00',0,'2013-09-21 10:43:54',1,'Y');
...
insert  into `inv_customer_info`(`customer_id`,`customer_code`,`depot_id`,`zone_id`,`customer_name`,`org_name`,`owner_name`,`customer_address`,`customer_contact_no`,`customer_bank_acc_no`,`customer_due_limit`,`entry_by`,`entry_date`,`last_update_by`,`last_update_date`,`company_id`,`active_flag`) values (1,'PT',1,1,'Peter','Zahan Pharmacy','Mijanur','Dhaka','018738439759','79437593479',0,1,'0000-00-00 00:00:00',NULL,NULL,1,'Y'),(2,'TT',2,1,'Test','Test','test','dhaka','2035349050','946749',0,1,'0000-00-00 00:00:00',NULL,NULL,1,'Y');
...
insert  into `vehicle_info`(`vehicle_id`,`vehicle_type`,`regi_no`,`managing_person_id`,`managing_person_name`,`entry_by`,`entry_date`,`last_update_by`,`last_update_date`,`current_status`,`company_id`,`active_flag`) values (1,'1','HGLJK8345830480',2,'Himel',1,'0000-00-00 00:00:00',NULL,NULL,'STAND BY',1,'Y');
