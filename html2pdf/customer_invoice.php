...
<table border="0" cellpadding="0" cellspacing="0" width="50%" align="center">
	...
	-->
    <thead>
    	<tr><td colspan="8"   style="border-top:#fff;border-left:#fff;border-right:#fff;border-bottom:#fff;font-weight:bold;text-align:center;font-family:Arial;">Semicon Private Ltd. </td></tr>
    	<tr><td colspan="8"   style="border-top:#fff;border-left:#fff;border-bottom:#fff;border-right:#fff;text-align:center;font-family:Arial;">DOHS Mohakhali</td></tr>		
    	<tr><td colspan="8"   style="border-top:#fff;border-left:#fff;border-bottom:#fff;border-right:#fff;text-align:center;font-family:Arial;">Road#21,House#21,Dhaka-1212.</td></tr>				
    	<tr><td colspan="8"   style="border-top:#fff;border-left:#fff;border-bottom:#fff;border-right:#fff;text-align:center;font-family:Arial;">Mobile:0176354875</td></tr>						
    	<tr><td colspan="8"   style="border-top:#fff;border-left:#fff;border-bottom:#fff;border-right:#fff;text-align:center;">&nbsp;</td></tr>
        <tr>
		    <th style="border-bottom:#fff;border-top:#000;background-color:#fff;font-family:Arial;">Card ID</th>
            <th style="border-bottom:#fff;border-top:#000;background-color:#fff;font-family:Arial;">Name</th>
            <th style="border-bottom:#fff;border-top:#000;background-color:#fff;font-family:Arial;">Style</th>
            <th style="border-bottom:#fff;border-top:#000;background-color:#fff;font-family:Arial;">Size</th>
            <th style="border-bottom:#fff;border-top:#000;background-color:#fff;font-family:Arial;">Quantity</th>
            <th style="border-bottom:#fff;border-top:#000;background-color:#fff;font-family:Arial;">Rate</th>
            <th style="border-bottom:#fff;border-top:#000;background-color:#fff;font-family:Arial;">Total</th>
            <th  style="border-bottom:#fff;border-top:#000;background-color:#fff;font-family:Arial;">Production Date</th>   
        </tr>          
    </thead>
	<tbody>
<?php $i=1;  	while($i<=8)  	{	?>
...
<?php		$i++;   }    ?>
  ...
  <table border="0" cellpadding="0" cellspacing="0" width="50%" align="center">
    ...
    <thead>
				<tr><td colspan="8"   style="border-top:#fff;border-left:#fff;border-right:#fff;border-bottom:#fff;font-weight:bold;text-align:center;">Semicon Private Ltd. </td></tr>
				<tr><td colspan="8"   style="border-top:#fff;border-left:#fff;border-bottom:#fff;border-right:#fff;padding-left:6px;">DOHS Mohakhali</td></tr>		
				<tr><td colspan="8"   style="border-top:#fff;border-left:#fff;border-bottom:#fff;border-right:#fff;text-align:center;">Road#21,House#21,Dhaka-1212.</td></tr>				
				<tr><td colspan="8"   style="border-top:#fff;border-left:#fff;border-bottom:#fff;border-right:#fff;text-align:center;">Mobile:0176354875</td></tr>						
				<tr><td colspan="8"   style="border-top:#fff;border-left:#fff;border-bottom:#fff;border-right:#fff;text-align:center;">&nbsp;</td></tr>
				<tr><td colspan="2" style="border-top:#fff;border-bottom:#fff;border-left:#fff;border-left:#fff;border-right:#fff;">Date:01/04/2013</td>
