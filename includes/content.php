					...
					<fieldset class="row3">
						...
						<p>
						 ...
						 <p>
						  ...
						  <input  id="inputDate" value="<?php echo date('m/d/Y');?>" />
						</p>
								...
								<div id="demo">
													<table cellpadding="0" cellspacing="0" border="0" class="display" id="example">
													 ...
													 <tr class="gradeA">
													   ...
													   <td>test1</td>
													   <td>test1</td>
													  <td><a href=""><img src="media/images/view-icone-6308-128.png" width="20" height="20" alt="View" title="View"></a><a href=""><img src="media/images/edit-notes.png" width="20" height="20" alt="Edit" title="Edit"></a><a href=""><img src="media/images/Delete_Icon.png" width="20" height="20" alt="Delete" title="Delete"></a></td>
													 </tr>
